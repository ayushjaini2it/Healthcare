...
const Dashboard: React.FC = () => {
  ...
  const stats = [
    { name: 'Total Patients', value: '1,246', icon: Users, change: '+12%', color: 'bg-blue-500' },
    ...
    { name: 'Discharges Today', value: '18', icon: FileText, change: '+15%', color: 'bg-purple-500' },
  ]
  ...
  return (
    <div className="space-y-6">
      {/* Header */}
      <div>
        <h1 className="text-3xl font-bold text-gray-900">Healthcare Supply Chain Dashboard</h1>
        <p className="text-gray-600 mt-2">Monitor and manage patient flow through the healthcare system</p>
      </div>
      ...
      <div className="card">
        <h2 className="text-xl font-semibold text-gray-900 mb-6">Patient Flow Process</h2>
        ...
        <div className="card">
          ...
          <div className="space-y-3">
            {isLoading ? (
              ...
              <div className="text-center py-4 text-gray-500">No recent patients found.</div>
            )}
          </div>
        </div>
