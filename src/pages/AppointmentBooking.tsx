    ...
    return (
      <div className="max-w-2xl mx-auto">
        <div className="card text-center py-10">
          ...
          <div className="bg-gradient-to-br from-indigo-50 to-purple-50 border border-indigo-100 rounded-xl p-6 text-left mb-6">
            ...
            <div className="grid grid-cols-2 gap-3 text-sm">
              <div>
                ...
                <p className="font-semibold text-gray-900">Dr. {bookedAppointment.doctorName}</p>
              </div>
              <div>
                <p className="text-gray-500">Specialization</p>
                <p className="font-semibold text-gray-900">{bookedAppointment.specialization || 'General'}</p>
              </div>
              <div>
                <p className="text-gray-500">Date</p>
                <p className="font-semibold text-gray-900">{new Date(bookedAppointment.appointment_date).toLocaleDateString('en-IN', { weekday: 'long', year: 'numeric', month: 'long', day: 'numeric' })}</p>
              </div>
              <div>
                <p className="text-gray-500">Time</p>
                <p className="font-semibold text-gray-900">{bookedAppointment.time_slot}</p>
              </div>
              <div className="col-span-2">
                <p className="text-gray-500">Status</p>
                <span className="inline-block mt-1 px-3 py-1 bg-blue-100 text-blue-700 rounded-full text-xs font-semibold">✓ Confirmed</span>
              </div>
            </div>
          </div>
  ...
  return (
    <div className="max-w-7xl mx-auto">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-600 mt-2">Schedule a consultation with one of our specialists.</p>
      </div>
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="card">
            ...
            {isLoading ? (
              ...
              <p className="text-gray-500 text-sm py-4">No doctors available. Please try again later.</p>
            ) : (
                ...
                {doctors.map(doctor => (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="font-semibold text-gray-900">Dr. {doctor.full_name}</p>
                      <p className="text-sm text-indigo-600">{doctor.specialization || 'General Physician'}</p>
          ...
          <div className="card">
            <h2 className="text-lg font-semibold text-gray-900 mb-4 flex items-center gap-2">
              <span className="w-7 h-7 rounded-full bg-indigo-600 text-white text-sm flex items-center justify-center font-bold">4</span>
        ...
        <div className="space-y-6">
                ...
                {selectedDoctor && (
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-indigo-600 text-xs">{selectedDoctor.specialization || 'General'}</p>
                    </div>
                  </div>
                )}
                {watch('date') && (
          ...
          <div className="card">
            <h3 className="font-semibold text-gray-900 mb-4 flex items-center gap-2">
              <User className="h-5 w-5 text-indigo-500" /> My Appointments
            </h3>
